            ...
            <form method="post" style="width: 80%; margin-top: 50px;margin-left: 150px">
                ...
                <div style="margin-top: 20px" class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input name="quantity_product" type="number" class="form-control" id="inputQuantity" placeholder="Enter quantity">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="inputName">Color</label>
                        <input name="color_product" type="text" class="form-control" id="inputColor" placeholder="Enter color">
                    </div>
                </div>
                ...
                <a class="btn btn-primary" href="admin?ac=list_product" role="button">Back</a>
            </form>
        </div>
    </div>
</div>
